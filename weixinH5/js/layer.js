...
;!function(win){
  ...
  Layer.prototype.view = function(){
    ...
    var button = (function(){
      ...
      if (btns === 3) {
        btndom = '<span ok type="2">' + config.btn[2] + '</span>' + '<span no type="1">' + config.btn[1] + '</span>' + '<span yes type="0">' + config.btn[0] + '</span>';
      }
  ...
  Layer.prototype.action = function(config, elem){
    ...
    var btn = function(){
      ...
      if(type == 0){
        ...
        config.ok ? config.ok(that.index) : layer.close(that.index);
      }
    };
    if(config.btn){
